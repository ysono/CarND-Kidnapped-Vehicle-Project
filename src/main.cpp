      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          if (!pf.initialized()) {
            ...
            // Provide noise for result of individual predicted states,
            // rather than noise for measured motion control (velocity and yaw_rate).
          ...
          pf.resample();
          Particle best_particle = pf.bestParticle();
